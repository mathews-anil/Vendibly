        ...
        <section className="relative py-10 sm:py-20 2xl:py-36 !pb-0 lg:pb-1.75">
            ...
            <div className="wrapper mt-[88px] sm:mt-[120px] lg:mt-[200px] xl:mt-[300px]">
                ...
                <div className="doc-text mb-10 sm:mb-16 md:mb-[91px]">
                    ...
                    <p className="">
                        This Privacy Policy explains how Vendibly
                        (&quot;Vendibly&quot;, &quot;we&quot;, &quot;us&quot;,
                        or &quot;our&quot;) collects, uses, shares, and protects
                        your information when you use our website, platform, and
                        related services (collectively, the “Services”). By
                        using Vendibly, you agree to the practices described
                        below.
                    </p>
                </div>
                <div className="pb-10 sm:pb-[78px] lg:pb-[123px] border-b border-b-foreground/15">
                    <div className="grid grid-cols-1 md:grid-cols-[265px_1fr] gap-x-5 lg:gap-x-[84px] space-y-5 sm:space-y-10 md:space-y-14 lg:space-y-[91px]">
                        ...
                        <div className="doc-text space-y-2">
                            <p>
                                We collect different types of data to support
                                our Services:
                            </p>
                            <ul className="list-inside list-[lower-alpha] space-y-2">
                                <li>
                                    ...
                                    <ul className="list-inside list-disc">
                                        <li>
                                            ...
                                            and other contact details you
                                            provide.
                                        </li>
                                        <li>
                                            Login credentials and user profile
                                            details within your team or
                                            organization.
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul className="list-inside list-disc">
                                        <li>
                                            ...
                                            communications, performance history,
                                            notes, and records
                                        </li>
                                        <li>
                                            Marketplace data you authorize us to
                                            access (e.g., product listings,
                                            orders, fulfillment info).
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul className="list-inside list-disc">
                                        <li>
                                            When you connect your email (Gmail,
                                            Outlook, etc.), we access:
                                            <ul className="indent-10 list-inside list-decimal">
                                                <li>
                                                    Relevant email content
                                                    exchanged with vendors or
                                                    business contacts
                                                </li>
                                                <li>
                                                    Metadata like
                                        ...
                                        <li>
                                            We only access emails necessary for
                                            delivering features like vendor
                                            insights, CRM tools, or
                                            communication timelines.
                                        </li>
                                        <li>
                                            We{" "}
                                            <span className="font-bold">
                                                do not access personal or
                                                unrelated emails.
                                            </span>
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    ...
                                    <ul className="list-inside list-disc">
                                        <li>
                                            Any contracts, invoices, catalogs,
                                            or other files you upload.
                                        </li>
                                        <li>
                                            These files are encrypted and stored
                                            securely.
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul className="list-inside list-disc">
                                        <li>
                                            ...
                                            information, referral URLs, and
                                            browsing behavior on Vendibly.ai.
                                        </li>
                                        <li>
                                            Cookies and tracking technologies
                                            used for analytics and platform
                                            optimization.
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <div className="doc-text space-y-2">
                            <p>
                                We only use your information for purposes
                                directly related to your experience with
                                Vendibly:
                            </p>
                            <ul className="list-inside list-disc">
                                <li>
                                ...
                                <li>
                                    To power vendor discovery, tracking,
                                    analytics, and CRM features
                                </li>
                                <li>
                                    To analyze communication patterns and
                                    surface insights via AI
                                </li>
                                <li>
                                    To respond to inquiries and support requests
                                </li>
                                <li>
                                    To administer your account and keep the
                                    platform secure
                                </li>
                                <li>
                                    To monitor usage, detect anomalies, and
                                    prevent fraud
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="doc-text space-y-2">
                            ...
                            <ul className="list-inside list-disc">
                                ...
                                <li>
                                    <span className="font-bold">
                                        We do not use your emails or vendor data
                                        for marketing, profiling, or advertising
                                    </span>
                                </li>
                                <li>
                                    <span className="font-bold">
                                        We do not read or access your personal
                                        email content.
                                    </span>
                                </li>
                                <li>
                                    We only use your data to provide the
                        ...
                        <div className="doc-text space-y-2">
                            <p>
                                Some Vendibly features use machine learning and
                                AI models to organize vendor information,
                                analyze communication trends, or suggest
                                actions. This processing is:
                            </p>
                            <ul className="list-inside list-disc">
                                <li>
                                    Transparent — you’ll always know what’s
                                    being analyzed
                                </li>
                                <li>
                                    Non-binding — no decisions are made that
                                    legally or financially affect users
                                </li>
                                <li>
                                    Controlled — limited to your synced or
                        ...
                        <div className="doc-text space-y-2">
                            <p>
                                When you connect third-party services (e.g.,
                                email, marketplaces, or data sources), we:
                            </p>
                            <ul className="list-inside list-disc">
                                <li>
                                    Only access data with your explicit
                                    authorization
                                </li>
                                <li>Use OAuth or secure API standards</li>
                                <li>
                                    Respect the scopes and limits of access
                                    granted
                                </li>
                                <li>
                                    Allow you to revoke integration access at
                                    any time
                                </li>
                            </ul>
                            <p>
                                If you connect Gmail, we comply fully with the
                        ...
                        <div className="doc-text space-y-2">
                            <p>
                                ...
                                advertisers or unrelated third parties. We may
                            ...
                            <ul className="list-inside list-disc">
                                <li>
                                    ...
                                    who help us deliver features securely (e.g.,
                                    cloud storage, email parsing, infrastructure
                                    partners)
                                </li>
                                <li>
                                    <span className="font-bold">
                                        Third-party tools you explicitly connect
                                        to
                                    </span>{" "}
                                </li>
                            </ul>
                        ...
                        <div className="doc-text space-y-2">
                            ...
                            <ul className="list-inside list-disc">
                                ...
                                <li>
                                    Secure cloud infrastructure and access
                                    controls
                                </li>
                                <li>Regular audits and monitoring</li>
                            </ul>
                            <p>
                                However, no method is 100% secure. You
                                acknowledge the inherent risks of digital
                                transmission.
                            </p>
                        </div>
                        ...
                        <div className="doc-text space-y-2">
                            <ul className="list-inside list-disc">
                                <li>
                                    ...
                                    you upload or sync to Vendibly
                                </li>
                                <li>
                                    You can request a copy of your data or ask
                                    us to delete it by contacting
                                    privacy@vendibly.ai.
                                </li>
                                <li>
                                    We retain data only as long as necessary to
                                    provide services or comply with legal
                                    requirements.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="doc-text space-y-2">
                            <p>
                                If you use Vendibly in a team or organization:
                            </p>
                            <ul className="list-inside list-disc">
                                <li>
                                    Data may be shared across team members
                                    depending on user roles and permissions.
                                </li>
                                <li>
                                    You are responsible for managing access
                                    controls within your workspace.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="doc-text space-y-2">
                            ...
                            <ul className="list-inside list-disc">
                                ...
                                <li>
                                    Object to processing or request data
                                    portability
                                </li>
                                <li>
                        ...
                        <div className="doc-text space-y-2">
                            <p>
                                Vendibly uses cookies and similar technologies
                                to:
                            </p>
                            <ul className="list-inside list-disc">
                        ...
                        <div className="doc-text space-y-2">
                            <p>
                                ...
                                time. When we do, we’ll update the
                                &ldquo;Effective Date&ldquo; and notify users of
                                significant changes.
                            </p>
                        </div>
